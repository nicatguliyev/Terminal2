...
public class StationListAdapter extends BaseAdapter {
    ...
    public StationListAdapter(Context context, ArrayList<WagonModel> wagons){
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {//
        ...
        if(i == 0){
            trainName.setText("Stansiyanı seçin");
            trainName.setTextColor(Color.parseColor("#FF007BFE"));
        }
        else
        {
            String trainNumber = wagons.get(i-1).getWagon_no();
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        ...
        {
            String trainNumber = wagons.get(position-1).getWagon_no();
            trainName.setText(trainNumber);
            trainName.setTextColor(Color.parseColor("#000000"));
            dropImage.setVisibility(View.INVISIBLE);
        }
